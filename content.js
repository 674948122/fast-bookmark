(function () {
    ...
    const i18n = {
        en: {
            ...
            footerText: "If you like this extension, please give us a star or feedback!",
            groupAbout: "About"
        },
        zh: {
            extensionName: "悬浮书签",
            ...
            groupContent: "内容",
            groupBehavior: "行为",
            footerText: "如果您喜欢这个扩展，请给我们一个 Star 或反馈问题！",
            groupAbout: "关于"
        }
    };
    ...
    <div id="fast-bookmark-modal">
      ...
      <div id="fast-bookmark-settings-modal">
        ...
        <div class="settings-scroll-container">
          ...
          <div class="settings-group-title" data-i18n="groupAbout">${getMsg("groupAbout")}</div>
          <div class="settings-group">
            <div class="settings-footer" style="margin-top: 0; padding-top: 8px; border-top: none;">
              <a href="https://github.com/674948122/fast-bookmark" target="_blank" class="settings-footer-link">
                ...
                <span>GitHub / 674948122/fast-bookmark</span>
              </a>
              <div class="settings-footer-text" data-i18n="footerText">${getMsg("footerText")}</div>
            </div>
          </div>
